...
export const home = [
  {
    ...
    design: "",
    desc: "Go-getter, result-oriented graduate from Jomo Kenyatta University of Agriculture and Technology and Moringa School where I pursued Business Innovation Technology Management and Software Engineering respectively. Proficient in application development, design, testing, deployment and implementation. Passionate about artificial intelligence and machine learning. Capable of communicating effectively both written and verbal with the ability to lead and organize in addition to; great interpersonal, critical thinking, teamwork and problem-solving skills. With a strong desire to continuously learn and in the long run, utilise my skills to better the society around me.",
  },
]
export const about = [
  {
